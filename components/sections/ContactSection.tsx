  ...
  return (
    <section id="contact" className="bg-pine py-[88px] px-[5vw]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
        ...
        <ScrollReveal variant="fade-left" delay={100} duration={620}>
          <div>
            <div className="flex flex-col gap-4 mb-10">
              {channels.map((ch, i) => (
                ...
                >
                  <div className={`w-11 h-11 rounded-[10px] flex items-center justify-center flex-shrink-0 ${ch.iconBg}`}>
                    {ch.icon}
                  </div>
        ...
        {/* Right — form */}
        <ScrollReveal variant="fade-right" delay={160} duration={620}>
          <EnquiryForm />
        </ScrollReveal>
      </div>
    </section>
