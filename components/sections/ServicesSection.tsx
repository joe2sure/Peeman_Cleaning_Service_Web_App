...
//           <div
//             key={service.slug}
//             className="bg-white border border-cream-mid rounded-xl p-7 hover:-translate-y-1 transition-transform duration-200 group relative overflow-hidden cursor-default"
//           >
//             {/* Bottom accent bar */}
//             <div className="absolute bottom-0 left-0 right-0 h-[3px] bg-pine-light scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left" />
